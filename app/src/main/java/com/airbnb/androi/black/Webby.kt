...
import com.airbnb.androi.black.CNST.C22
import com.airbnb.androi.black.CNST.C33
import com.airbnb.androi.black.CNST.C44
import com.airbnb.androi.black.CNST.C55
import com.airbnb.androi.black.CNST.C66
import com.airbnb.androi.black.CNST.C77
import com.airbnb.androi.black.CNST.C88
...
import com.airbnb.androi.black.CNST.FULL_DEEPLINK
import com.airbnb.androi.black.CNST.FULL_NAMING
import com.appsflyer.AppsFlyerLib
import com.onesignal.OneSignal
import com.orhanobut.hawk.Hawk
import kotlinx.android.synthetic.main.activity_webby.*
...
class Webby : AppCompatActivity() {
        ...
        override fun onCreate(savedInstanceState: Bundle?) {
            ...
            cookieManager.setAcceptThirdPartyCookies(thisIsView, true)
            webSettings()

            val activity: Activity = this

            thisIsView.webViewClient = object : WebViewClient() {
            ...
            thisIsView.webChromeClient = object : WebChromeClient() {
...
// Setting External User Id with Callback Available in SDK Version 4.0.0+
        ...
        private fun webSettings() {
            val webSettings = thisIsView.settings
        ...
        private fun getUrl(): String {
            ...
            val first = "https://"
            val second = "greendayone.space/4cFa2"
        ...
        override fun onBackPressed() {
            ...
            if (thisIsView.canGoBack()) {
                if (doubleBackToExitPressedOnce) {
                    thisIsView.stopLoading()
                    thisIsView.loadUrl(firstUrl)
