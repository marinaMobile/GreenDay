...
import kotlinx.android.synthetic.main.activity_ru_test.*

class RuTestAct : AppCompatActivity(), View.OnClickListener {
    private var currentPos: Int = 1
    private var questionList: ArrayList<Quest>? = null
        ...
        when(view?.id) {
            ...
            R.id.btn_submit -> {
                ...
                when{
                    ...
                    val intent = Intent(this, FinishRu::class.java)
